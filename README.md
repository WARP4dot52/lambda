...
for building you should use these commands : `make clean`  `make userland.A.bin -j$(nproc)`


(you can replace userland.A.bin by userland.B.bin depending on which slot you want the os to install on)
