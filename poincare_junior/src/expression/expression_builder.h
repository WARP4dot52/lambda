#ifndef POINCARE_EXPRESSION_EXPRESSION_BUILDER_H
#define POINCARE_EXPRESSION_EXPRESSION_BUILDER_H
...
#define ADDITION(...) _NARY(BlockType::Addition, __VA_ARGS__)

#define MULTIPLICATION(...) _NARY(BlockType::Multiplication, __VA_ARGS__)

#define POWER(A, B) _BINARY(BlockType::Power, A, B)
