...
QUIZ_CASE(pcj_inverse_trigonometry) {
  ...
  // TODO
  simplifies_to(
      "acos({0, (√(3)-1)/(2*√(2)), 1/2, 1/√(2), √(3)/2, (√(3)+1)/(2*√(2)), 1})",
      "{π/2, 5π/12, π/3, π/4, π/6, π/12, 0}");
  simplifies_to(
      "acos(-{(√(3)-1)/(2*√(2)), 1/2, 1/√(2), √(3)/2, (√(3)+1)/(2*√(2)), 1})",
      "{7π/12, 2π/3, 3π/4, 5π/6, 11π/12, 0}");
  simplifies_to(
      "asin({0, (√(3)-1)/(2*√(2)), 1/2, 1/√(2), √(3)/2, (√(3)+1)/(2*√(2)), 1})",
      "{0, π/12, π/6, π/4, π/3, 5π/12, π/2}");
  simplifies_to(
      "asin(-{(√(3)-1)/(2*√(2)), 1/2, 1/√(2), √(3)/2, (√(3)+1)/(2*√(2)), 1})",
      "{-π/12, -π/6, -π/4, -π/3, -5π/12, -π/2}");
#endif
}
